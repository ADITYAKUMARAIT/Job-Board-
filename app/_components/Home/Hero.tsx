        ...
        <div className='w-[100%] h-[50vh]  flex flex-col items-center justify-center'>
            <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-[2rem]' >
                <div className='hidden lg:block'>
                    <Image src='/hero.svg' alt='image' height={700} width={500}></Image>
                </div>
                <div>
                    <h1  className='text-[85px] sm:text-[35px] lg:text-[45px] xl:text-[60px] text-[#05264e] leading-[3rem]  lg:leading-[4rem] font-extrabold'>The <span className='text-blue-500'>Easiest Way</span><br/> To Get Your New Job </h1>
                    ...
                    <div className='mt-[1.5rem]'>
                        <input className='w-[60%] md:w-[70%] lg:w-[75%] px-5 py-4 outline-none  rounded-1-md bg-gray-200 ' type='text' placeholder='Search Job'></input>
